...
name: Build and deploy Node.js app to Azure Web App - RFIDScannerWebApp
  ...
  deploy:
    ...
    steps:
      ...
      - name: 'Deploy to Azure Web App'
        ...
        id: deploy-to-webapp
        with:
          app-name: 'RFIDScannerWebApp'
          slot-name: 'Production'
          publish-profile: ${{ secrets.AZUREAPPSERVICE_PUBLISHPROFILE_9969F74DFEDD4EDCA16E82C084362BAA }}
          package: .
